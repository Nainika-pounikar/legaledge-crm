...
function EmptyCard({ message, buttonLabel, onAdd }) {
  return (
...
function TaskTabs({ active, onChange }) {
  return (
  ...
  return (
    <div className="home-wrapper">
      ...
      <section className="home-section">
        ...
        <EmptyCard message="You don't have any meetings today" buttonLabel="New meeting" onAdd={() => navigate('/calls')} />
      </section>
      ...
      <section className="home-section">
        ...
        <EmptyCard message="You have no tasks today" buttonLabel="New Task" onAdd={() => navigate('/tasks')} />
      </section>
        ...
        <div className="activity-grid">
          ...
          <div className="activity-card">
            <div className="activity-card-header">
              <span className="activity-label">Contact</span>
              <span className="activity-badge badge-blue">Customer</span>
            </div>
            <div className="activity-card-body">
              <h4 className="activity-primary-name">Shailesh Kumar</h4>
              <p className="activity-timestamp">Edited 2 hours ago</p>
            </div>
            <div className="activity-card-footer">
              <button className="activity-summarize-btn" onClick={() => showToast('Summarizing recent contact activity...')}>
                <span className="spark-icon"><i className="fa-solid fa-wand-magic-sparkles"></i></span> Summarize content
              </button>
            </div>
          </div>
          ...
          <div className="activity-card">
            <div className="activity-card-header">
              <span className="activity-label">Marketing email</span>
              <span className="activity-badge badge-gray">Draft</span>
            </div>
            <div className="activity-card-body">
              <h4 className="activity-subject">April Newsletter Campaign</h4>
              <p className="activity-timestamp">Created 5 hours ago</p>
            </div>
          </div>
          ...
          <div className="activity-card">
            <div className="activity-card-header">
              <span className="activity-label">Contact</span>
              <span className="activity-badge badge-blue">Lead</span>
            </div>
            <div className="activity-card-body">
              <h4 className="activity-primary-name">Aditya Verma</h4>
              <p className="activity-timestamp">Created yesterday</p>
            </div>
            <div className="activity-card-footer">
              <button className="activity-summarize-btn" onClick={() => showToast('Summarizing recent contact activity...')}>
                <span className="spark-icon"><i className="fa-solid fa-wand-magic-sparkles"></i></span> Summarize content
          ...
          <div className="activity-card">
            ...
            <div className="activity-card-body">
              <h4 className="activity-subject">Follow-up: LegalEdge Intro</h4>
              <p className="activity-timestamp">Edited 1 day ago</p>
            </div>
          </div>
        </div>
