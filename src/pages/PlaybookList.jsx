                    ...
                    <tr key={p.id} className={selectedRows.includes(p.id) ? 'table-active' : ''}>
                      ...
                      <td>
                        <div className="d-flex gap-1">
                          <button className="btn btn-sm btn-outline-secondary p-1" title="Edit" onClick={() => showToast(`Editing ${p.name}`)}>
                            <i className="fa-solid fa-pen fa-xs"></i>
                          </button>
                          <button className="btn btn-sm btn-outline-secondary p-1" title="More" onClick={() => showToast(`More actions for ${p.name}`)}>
