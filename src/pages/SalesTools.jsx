          ...
          <tbody>
            {store.documents.map(d => (
              <tr key={d.id}>
                ...
                <td>
                  <div style={{ display: 'flex', gap: 6 }}>
                    <button className="btn-icon" onClick={() => showToast('Link copied!')}><i className="fa fa-share"></i></button>
                    <button className="btn-icon edit" onClick={() => showToast('Edit doc')}><i className="fa fa-pen"></i></button>
