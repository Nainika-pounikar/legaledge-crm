...
const DEPARTMENTS = ['Sales', 'Marketing', 'Legal', 'Finance', 'Operations', 'HR', 'Technology'];
const TIMEZONES = ['Asia/Kolkata', 'Asia/Dubai', 'Europe/London', 'America/New_York', 'America/Los_Angeles', 'UTC'];

export default function AddManager() {
    const navigate = useNavigate();
    const { currentUser, addRecord, showToast } = useCRM();
                ...
                <form onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="form-actions" style={{ marginTop: 32, display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
                        ...
                        <button
                            ...
                            style={{ opacity: submitted && !isValid ? 0.6 : 1, cursor: submitted && !isValid ? 'not-allowed' : 'pointer' }}
                        >
