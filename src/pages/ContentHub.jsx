    ...
    <div>
      <div className="page-header">
        ...
        <div className="page-actions">
          <button className="btn-primary" onClick={() => showToast('New blog post')}><i className="fa fa-plus"></i> New Post</button>
        </div>
      </div>
              ...
              <tr key={b.id}>
                ...
                <td>
                  <div style={{ display: 'flex', gap: 6 }}>
                    <button className="btn-icon edit" onClick={() => showToast('Edit post')}><i className="fa fa-pen"></i></button>
                    <button className="btn-icon" onClick={() => showToast('Preview opened')}><i className="fa fa-eye"></i></button>
