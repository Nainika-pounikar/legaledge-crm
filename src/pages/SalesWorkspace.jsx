...
export default function SalesWorkspace() {
  ...
  return (
    <div className="page-fade">
      ...
      <div className="cards-grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px', marginBottom: '20px' }}>
        <div className="card">
      ...
      <div className="cards-grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
...
<table className="data-table" style={{ marginTop: '10px' }}>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', marginTop: '15px' }}>
            {MEETINGS.map(m => (
              <div key={m.id} style={{ display: 'flex', alignItems: 'center', background: 'var(--bg-hover)', borderRadius: '8px', padding: '12px' }}>
