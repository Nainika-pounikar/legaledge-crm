...
export default function BuyerIntentPage() {
  ...
  useEffect(() => {
    const data = JSON.parse(localStorage.getItem("marketing_buyer_intent")) || [];
    setItems(data);
  }, []);
  ...
  const handleSave = () => {
    ...
    localStorage.setItem("marketing_buyer_intent", JSON.stringify(updatedData));
            ...
            <>
              <div className="card" style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: 'var(--radius)', overflow: 'hidden' }}>
                ...
                <div style={{ padding: '40px 20px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                  ...
                  <p style={{ fontSize: '14px', color: '#64748b', maxWidth: '400px', lineHeight: '1.5', margin: '0 auto', textAlign: 'justify' }}>
